<?php
	...
	if($keyword!='' && $keyword!='Keyword'){
		$strwhere.="AND ( `company_name` like N'%$keyword%')";
	}
  ...
  <form id="frm_list" name="frm_list" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
        ...
        <td width="50" align="center"><?php echo "PARTNER_ID";?></td>
		<td align="center"><?php echo "Logo";?></td>
        <td align="center"><?php echo "Nhà cung cấp";?></td>
      ...
      <?php
	  $obj->listTablePartner($strwhere,$cur_page,0);
	  ?>
