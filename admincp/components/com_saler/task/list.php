<?php
	...
	if($keyword!='' && $keyword!='Keyword'){
		$strwhere.="AND ( `cty_name` like N'%$keyword%')";
	}
  ...
  <form id="frm_list" name="frm_list" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
        ...
        <td width="50" align="center"><?php echo "SALE_ID";?></td>
        <td align="center"><?php echo "Tên Saler";?></td>
        <td align="center">Phone</td>
        <td align="center">Address</td>
        <td align="center">Người đại diện</td>
      ...
      <?php
	  $obj->listTableCate($strwhere,$cur_page,0);
	  ?>
