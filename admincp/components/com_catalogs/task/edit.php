...
$(document).ready(function(){
  ...
  <form id="frm_action" name="frm_action" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" style="border:#CCC 1px solid;">
	  ...
	  <tr>
		<td width="150" align="right" bgcolor="#EEEEEE"><strong>Thẻ H1 </strong></td>
        <td>
          <textarea name="txth1" id="txth1" style="width:80%" rows="2" maxlength="255"><?php echo $row['h1'];?></textarea>
		</td>
	  </tr>
      <tr>
