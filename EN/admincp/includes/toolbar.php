    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <?php 
            ...
            if(!isset($_GET["task"])){
        ?>
			<li><a class="edit" href="index.php?com=<?php echo COMS;?>" title="Danh sách">Danh sách</a></li>
            ...
            <?php }else{
			if($_GET['task']=="preview") {
				if($_GET['active']==2){
			?>
			<li><a class="save"  href="#" onclick="dosubmitAction('frm_menu','accept');" title="Duyệt">Duyệt</a></li>
				<?php } else { ?>
			<li valign="middle"></li>
			<?php }
			 }else { ?>
