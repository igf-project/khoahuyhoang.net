...
<form id="frm_login" name="frm_login" method="post" action="" AUTOCOMPLETE="off" >
	...
	<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
		...
		<td width="50%"><input type="text" name="txtuser" id="txtuser" class="text" /></td>
		</tr>
		<tr>
		<td align="right">Mật khẩu</td>
		<td><input type="password" name="txtpass" id="txtpass" class="text"/></td>
		</tr>
		<tr>
		<td align="right">Mã bảo mật</td>
		<td>
		<input style="float:left;" type="text" size="7" name="txt_sercurity" id="txt_sercurity" class="text"/>
