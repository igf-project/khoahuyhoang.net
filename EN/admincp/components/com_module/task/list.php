  ...
  <form id="frm_list" name="frm_list" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
        ...
        <th width="100" align="center"><?php echo TYPE;?></th>
		<th width="100" align="center">Giao diện</th>
        <th width="100" align="center"><?php echo CPOSITION;?></th>
	  ...
	  <tr>
		...
		<td align="center">
			<input type="text" value="<?php echo $rows['order'];?>" name='txt_order'/>
		</td>
