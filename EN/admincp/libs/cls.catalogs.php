...
class CLS_CATALOGS{
	...
	function Add_new(){
		$sql=" INSERT INTO `tbl_catalog`(`par_id`,`alias`,`name`,`thumb`,`intro`,`meta_title`,`meta_desc`,`meta_key`,`isactive`) VALUES";
		$sql.="('".$this->ParID."','".$this->Alias."','".$this->Name."','".$this->Thumb."','".$this->Intro
				."','".$this->Meta_Title."','".$this->Meta_Desc."','".$this->Meta_Key."','".$this->isActive."')";
		return $this->objmysql->Exec($sql);
	}
	function Update(){
		$sql = "UPDATE tbl_catalog SET par_id='".$this->ParID."',`alias`=N'".$this->Alias."',`name`=N'".$this->Name."',`thumb`=N'".$this->Thumb
				."',`intro`=N'".$this->Intro."',`meta_title`=N'".$this->Meta_Title
