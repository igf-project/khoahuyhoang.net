...
<head>
	...
	<link rel="stylesheet" href="<?php echo ROOTHOST.THIS_TEM_PATH; ?>css/gf-style.css?v=1">
...
<div id="gf-header" class='clearfix'>
	...
	<div class="navbar-header">
		...
		<a class='navbar-brand' href="<?php echo ROOTHOST;?>" title="Logo Huy Hoang Lock - Manufacturer of professional courses since 1979">
			<img src="<?php echo ROOTHOST;?>images/logo/logo-huyhoang2.png" alt="Logo Lock elephant Huy Hoang" class="img-responsive" width="300">
		</a>
	</div>
	<div id="nav" class='collapse navbar-collapse'>
		<ul class='nav navbar-nav navbar-right'>
			...
			<li class='flag'><a href="http://khoahuyhoang.net/" class="vi" rel="nofollow" title="Vietnam">
				<img src="<?php echo ROOTHOST.'images/flags/flag-vietnam.png';?>" alt="Flag Viet Nam"/></a></li>
			<li class='flag'><a href="<?php echo ROOTHOST;?>" class="en" rel="nofollow" title="English">
				<img src="<?php echo ROOTHOST.'images/flags/flag-english.png';?>" alt="Flag English"/></a></li>
		</ul>
	</div>
	</div>
	<div id="search">
	<form id="frmsearch" action="<?php echo ROOTHOST.'search/';?>" method="post">
		<input type="text" placeholder="Enter search keywords" name="txtsearch" id="txtsearch"/>
	</form></div>
</div>
...
<div id="banner" class="container-fluid">
	...
	if($this->isFrontpage()) {
		...
		if($com=='products') {
			...
			switch($code) {
				case 'lock-grip': $this->loadModule("banner2"); break;
				case 'lock-hanging': $this->loadModule("banner10"); break;
				case 'lock-handles-hc': $this->loadModule("banner4"); break;
				case 'lock-handles-ss': $this->loadModule("banner5"); break;
				case 'cremone':
				case 'latch-cremone': $this->loadModule("banner6"); break;
				case 'cremone-hc': $this->loadModule("banner7"); break;
				case 'cremone-ex': $this->loadModule("banner8"); break;
				case 'retail': 
				case 'hinges-inox':
				case 'hinge-paint':$this->loadModule("banner9"); break;
...
<footer>
	<div class="container">
		<div class="module col-md-9 col-sm-9 col-xs-12">
			<div class="col-md-12">
				<a href="<?php echo ROOTHOST;?>" title="Huy Hoang Company Logo">
					<img alt="Huy Hoang lock elephant logo (blue)" class="logo" src="<?php echo ROOTHOST.'images/logo/logo-huyhoang1.png';?>">
				</a>
			</div>
			<?php $this->loadModule("footer");?>
			<div class="module col-md-4 col-sm-4 col-xs-12">
				<span style="font-weight: bold;"> Other channels</span><br />
				<ul class="social-icons">
				  <li><a href="https://www.facebook.com/khoahuyhoang.net" target="_blank" title="Facebook Huy Hoang Lock " rel="nofollow"><span class="social social-facebook"></span></a></li>
				  <li><a href="https://twitter.com/khoahuyhoangnet" target="_blank" title="Twitter Huy Hoang Lock" rel="nofollow"><span class="social social-twitter"></span></a></li>
		...
		<div id="social-like" class="module col-md-3 col-sm-3 col-xs-12">
			<div class="fb-page" width="260" height="200" data-href="https://www.facebook.com/khoahuyhoang.net" data-small-header="true" data-adapt-container-width="false" data-hide-cover="true" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/khoahuyhoang.net"><a href="https://www.facebook.com/khoahuyhoang.net">Lock Huy Hoang</a></blockquote></div></div>
		</div>
		<div class="copyright text-center">© Copyright 2016. Huy Hoang Lock Company Limited </div>
	</div>
