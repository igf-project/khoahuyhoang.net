...
class CLS_GALLERY{
	...
	function ListAlbum($strwhere="",$no_id=0){
		...
		{	
			...
			echo '<div class="item-gallery">
					...
					<a class="detail" href="/project/'.$id.'" class="readmore">View more <span class="glyphicon glyphicon-play-circle"></span></a>
				</div>';
		}
	}
	function ListGallery($strwhere="",$order=" ORDER BY `order` ASC, id DESC"){
		...
		{	
			...
			$link = ROOTHOST.'project/'.$id.'/'.un_unicode($name).'.html';
			echo '<div class="item-gallery">
