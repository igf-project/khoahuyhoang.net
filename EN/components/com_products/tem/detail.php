...
<div class='pro_info'>
	...
	<div class='col-md-6 col-sm-6 col-xs-6 info'>
		...
		<div class="pro_intro">
		<ul><li><span class="pro_label">Product code:</span><span class="pro_text"><strong><?php echo $pro_code;?></strong></span></li>
		<li><span class="pro_label">Trademark:</span><span class="pro_text"><strong>Huy Hoang Lock</strong></span></li></ul>
		<?php if($intro!='') { ?>
		<?php echo $intro;?>
		<?php } ?>
		</div>
		...
		<div class="clr"></div>
		<hr size=1 width="100%">
		<div class="price"><a href="<?php echo ROOTHOST.'lien-he';?>">Contacts quote  <span class="glyphicon glyphicon-forward"></span></a></div>
	</div>
</div>
<div class="clr"></div>
<?php if($content!='') {
...
<div class="detail_product rows" code='detail'>
	<div id="tabs">
		<ul>
		<li rel="tab-feature" class="active">Function</li>
		<li rel="tab-techno">Digital</li>
		<li rel="tab-document">Manual document</li>
		</ul>
	</div>
	<?php //if($_SERVER['REMOTE_ADDR']=="1.55.150.126") { ?>
	<div id="tab-feature" class="tab_content"><h2>Function of <?php echo $name;?></h2><?php echo $info;?></div>
	<div id="tab-techno" class="tab_content"><h2>Digital <?php echo $name;?></h2><?php echo $techno;?></div>
	<div id="tab-document" class="tab_content"><h2>Manual document <?php echo $name;?></h2><?php echo $document;?></div>
	<?php /*} else { ?>
	<div id="tab-feature" class="tab_content"><?php //echo $info;?></div>
	<div id="tab-techno" class="tab_content"><?php //echo $techno;?></div>
	<div id="tab-document" class="tab_content"><?php //echo $document;?></div>
	<?php }*/ ?>
<?php 
...
<div class="rows col-relates">
	<h3 class="tieu-de"><span><?php echo $cat_code;?> Same type</span></h3>
...
<!----- RELATES PRODUCTS ----->
<div class="rows col-relates">
	<div class="tieu-de"><span>Maybe you are interested</span></div>
